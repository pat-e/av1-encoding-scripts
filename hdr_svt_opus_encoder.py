...
def main(preset=None, crf=None, grain=None, norm_i=None, norm_tp=None):
...
if __name__ == "__main__":
    ...
    main(preset=args.preset, crf=args.crf, grain=args.grain, norm_i=args.norm_i, norm_tp=args.norm_tp)
